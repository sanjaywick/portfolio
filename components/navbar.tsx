      ...
      <div className="container mx-auto px-4 md:px-8 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-8 items-center">
          {navLinks.map((link) => (
            ...
            >
              {link.name}
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-sky-500 to-cyan-500 transition-all duration-300 group-hover:w-full"></span>
            </Link>
          ))}
          <motion.a
            href="https://github.com/sanjaywick"
            target="_blank"
          ...
          <motion.a
            href="https://linkedin.com/in/vv-sanjay-a71a7a234"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-white transition-colors duration-300"
            aria-label="LinkedIn"
