...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Sanjay V V - Full Stack Developer & Tech Innovator</title>
        <meta
          name="description"
          content="Portfolio of Sanjay V V, a Full Stack Developer and Decision Sciences student specializing in modern web technologies."
        />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Strategic digital marketing campaigns with proven results in lead generation and SEO.",
                  },
                ].map((service, index) => (
                  <motion.div
                    key={index}
        ...
        <footer className="py-12 bg-gradient-to-t from-gray-900 to-black">
          <div className="container px-4 mx-auto">
            ...
            >
              ...
              <SocialIcon icon={<MessageSquare />} href="mailto:vvsanjay10102003@gmail.com" label="Email" />
